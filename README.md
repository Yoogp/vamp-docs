...
# heres all the functions you needa know
# init the window
lib:CreateWindow()

# how to make tabs
local tab1 = lib:CreateTab("test")
local tab2 = lib:CreateTab("you can change them")
# make sure when you make tabs order them
# ex: local tab3
# local tab4 and yk

# create buttons
lib:CreateButton("Button Example", tab1, function(callback)
	print("test")
end)
# make sure to change the tab1 thing to the tab you want it to be

# create sliders
lib:CreateSlider("Slider Example", tab1, 0, 25, 0, function(value)
	print(value)
end)
